...
def dicom_to_image(in_dir, out_dir, HU=False):
    if ".dcm" in in_dir:
        print("gijweifgjeawiofjaiowefjioawefjioawejfawjioef")
        file_list = in_dir
        ds = dcmread(file_list)  # 讀dicom
        # print(ds) # 印出dicom內的所有屬性
        #file_name = ds.Modality + "_" + ds.SOPInstanceUID   # 保存影像用的檔名，可以自己改
        file_name =Path(file_list).stem
...
if __name__ == "__main__":
    dicom_to_image(in_dir=r"D:\UI\CAT-UNet\dcm_data\0_mass_1033_0_00.dcm",
